...
public class KickMemberServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            enrollmentDAO = new EnrollmentDAO(DBConnection.getConnection());
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(KickMemberServlet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet KickMemberServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet KickMemberServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
